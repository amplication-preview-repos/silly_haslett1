...
@InputType()
class UtilisateurCreateNestedManyWithoutFederationsInput {
...
export { UtilisateurCreateNestedManyWithoutFederationsInput as UtilisateurCreateNestedManyWithoutFederationsInput };
