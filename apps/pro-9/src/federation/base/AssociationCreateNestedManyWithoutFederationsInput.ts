...
@InputType()
class AssociationCreateNestedManyWithoutFederationsInput {
...
export { AssociationCreateNestedManyWithoutFederationsInput as AssociationCreateNestedManyWithoutFederationsInput };
