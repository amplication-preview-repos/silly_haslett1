...
@InputType()
class AffectationCreateNestedManyWithoutAssociationsInput {
...
export { AffectationCreateNestedManyWithoutAssociationsInput as AffectationCreateNestedManyWithoutAssociationsInput };
