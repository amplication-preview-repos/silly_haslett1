...
@InputType()
class FederationCreateNestedManyWithoutSalariesInput {
...
export { FederationCreateNestedManyWithoutSalariesInput as FederationCreateNestedManyWithoutSalariesInput };
